...
class CommunicationScreenEdit extends StatefulWidget {
  const CommunicationScreenEdit({super.key});

  @override
  State<CommunicationScreenEdit> createState() => CommunicationScreenEditState();
}

class CommunicationScreenEditState extends State<CommunicationScreenEdit> {
    late String selectedString;
  int isSelected = -1;
